...
resource "aws_dynamodb_table" "hanna-bookinventory-tf" {
  name         = "hanna-bookinventory-tf"
...
resource "null_resource" "insert_books" {
  depends_on = [aws_dynamodb_table.hanna-bookinventory-tf]  # ensures table is ready
